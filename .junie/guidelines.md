...
10. **Don't directly edit the generated files**: Files within the folder `android-native/src/main/generated` are generated by the build process. They should never be directly edited. Instead, edit the classes that generate them (found within `buildSrc/src/main/java/com/onemillionworlds/tamarin/gradle/tasks/generators`)
