...
class IntTypeDefPasserTest {
    ...
    void parseIntTypedef_validIntTypedef() {
        ...
        Optional<String> result = IntTypeDefPasser.parseIntTypedef(line, List.of());
    ...
    @Test
    void parseIntTypedef_nested() {
        String line = "typedef SomeRandomType XrNewIntType;";
        Optional<String> result = IntTypeDefPasser.parseIntTypedef(line, List.of("SomeRandomType"));
        assertEquals(Optional.of("XrNewIntType"), result);
    }
}