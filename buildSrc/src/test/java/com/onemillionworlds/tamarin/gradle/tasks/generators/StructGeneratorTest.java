...
public class StructGeneratorTest {
    ...
    private static final String expectedXrActionCreateInfo = """
            ...
            public class XrActionSetCreateInfo extends Struct<XrActionSetCreateInfo> {
                ...
                public static void ntype(long struct, int value ) { return memSetInt(struct + XrActionSetCreateInfo.TYPE, value); }
                /** Unsafe version of {@link #next}. */
                public static long nnext(long struct) { return memGetAddress(struct + XrActionSetCreateInfo.NEXT); }
                public static void nnext(long struct, long value) { return memSetAddress(struct + XrActionSetCreateInfo.NEXT, value); }
                ...
                public static void npriority(long struct, int value) { return memSetInt(struct + XrActionSetCreateInfo.PRIORITY, value); }
