 ...
 * (and isn't a pointer)
 */
public class StuctGeneratorTest_XrHandCapsuleFB {
    private static final String expectedXrHandCapsuleFB = """
            /*
            ...
            public class XrHandCapsuleFB extends Struct<XrHandCapsuleFB> {
                ...
                public static class Buffer extends StructBuffer<XrHandCapsuleFB, Buffer> {
                    ...
                    /** Sets the specified value to the {@code radius} field. */
                    public Buffer radius(float value) {\s
                        XrHandCapsuleFB.nradius(address(), value);
                        return this;
                    }
                    /** Sets the specified value to the {@code joint} field. */
                    public Buffer joint(XrHandJointEXT value) {\s
                        XrHandCapsuleFB.njoint(address(), value.getValue());
                        return this;
                    }
                }
    ...
    private static final String xrHandCapsuleFB_cDefinition = """
    ...
    void testGenerateXrVisibilityMaskKHR() throws IOException {
        BufferedReader reader = new BufferedReader(new StringReader(xrHandCapsuleFB_cDefinition));
        ...
        structDefinition.getFields().get(0).getJavaType();

        String result = StructGenerator.generateStruct(structDefinition);



        assertEquals(expectedXrHandCapsuleFB.trim(), result.trim());
    }
