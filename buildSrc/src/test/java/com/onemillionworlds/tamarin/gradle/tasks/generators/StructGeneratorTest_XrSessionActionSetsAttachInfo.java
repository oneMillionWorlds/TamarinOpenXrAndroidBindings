 ...
 */
public class StructGeneratorTest_XrSessionActionSetsAttachInfo {
    ...
    private static final String expected = """
        ...
        public class XrSessionActionSetsAttachInfo extends Struct<XrSessionActionSetsAttachInfo> {
            ...
            public static XrActionSet.Buffer nactionSets(long struct) {\s
                ...
                return XrActionSet.create(buffer, address);\s
            }
            ...
            public static class Buffer extends StructBuffer<XrSessionActionSetsAttachInfo, Buffer> {
                ...
                /** Sets the specified value to the {@code countActionSets} field. */
                public Buffer countActionSets(int value) {\s
                    XrSessionActionSetsAttachInfo.ncountActionSets(address(), value);
                    return this;
                }
                /** Sets the specified value to the {@code actionSets} field. */
                public Buffer actionSets(XrActionSet.Buffer value) {\s
                    XrSessionActionSetsAttachInfo.nactionSets(address(), value);
                    return this;
                }
                /** Sets the specified value to the {@code type} field. */
    ...
    private static final String xrSessionActionSetsAttachInfo_cDefinition = """
    ...
    void testGenerateXrInteractionProfileDpadBindingEXT() throws IOException {
        ...
        BufferedReader reader = new BufferedReader(new StringReader(xrSessionActionSetsAttachInfo_cDefinition));
